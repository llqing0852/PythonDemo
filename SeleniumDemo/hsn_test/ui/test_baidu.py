...
from hsn_test.page.baidu_main_page import BaiDuMainPage
from hsn_test.page.baidu_result_page import BaiDuResultPage
...
if __name__ == '__main__':
    ...
    e = Email(title='百度搜索测试报告',
              ...
              receiver='llqing0852@hotmail.com',
              server='smtp.qq.com',
              sender='281890818@qq.com',
              password='rmtfcwvkbrhlbjag',
              path=report
              )
    e.send()
